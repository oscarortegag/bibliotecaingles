...
<h3 class="card-title">Editar registro  <i>{{$material_ingles->titulo }}</i>
</h3>
</div>


<form action="{{ route('librosingles.update', $material_ingles) }}" method="POST">
     @method('put')
     <form>
@csrf   
<div class="card-body">
  <div class="form-group">
     <label for="titulofrances">Titulo</label>
       <input type="text" name="titulo" class="form-control" id="titulofrances" placeholder="ingrese titulo" value="{{ $material_ingles->titulo }}">
</div>
   <div class="form-group">
